...
export default function Privacy() {
  ...
  const content = {
    ka: {
      ...
      section4Text: 'თქვენ უფლება გაქვთ მოითხოვოთ თქვენი პერსონალური მონაცემების ნახვა, შესწორება ან სრული წაშლა ჩვენი ბაზიდან. ამისთვის დაგვიკავშირდით ელ-ფოსტაზე: stdancegroupdue@gmail.com ან ტელეფონზე: +995 514 19 99 66.'
    },
    en: {
      ...
      section4Text: 'You have the right to inspect, update, or request the deletion of your personal data at any time. To exercise your rights, please contact us at stdancegroupdue@gmail.com or call +995 514 19 99 66.'
    },
    ru: {

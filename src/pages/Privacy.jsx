...
export default function Privacy() {
  ...
  const content = {
    ka: {
      ...
      section4Text: 'თქვენ უფლება გაქვთ მოითხოვოთ თქვენი პერსონალური მონაცემების ნახვა, შესწორება ან სრული წაშლა ჩვენი ბაზიდან. ამისთვის დაგვიკავშირდით ელ-ფოსტაზე: stdancegroup@gmail.com ან ტელეფონზე: +995 555 13 00 13.'
    },
    en: {
      ...
      section4Text: 'You have the right to inspect, update, or request the deletion of your personal data at any time. To exercise your rights, please contact us at stdancegroup@gmail.com or call +995 555 13 00 13.'
    },
    ru: {
      ...
      section4Text: 'Вы имеете право запросить просмотр, исправление или полное удаление ваших персональных данных. Для этого свяжитесь с нами по эл. почте: stdancegroup@gmail.com или по телефону: +995 555 13 00 13.'
    }
  }

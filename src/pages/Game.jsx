...
export const gameTranslations = {
  ka: {
    ...
    subtitle: 'გაატეხე ბრიქები, დააგროვე ქულები და მოიგე ST Dance-ის სექტემბრის პრიზები!',
    gameOver: 'GAME OVER',
  ...
  en: {
    ...
    subtitle: 'Break bricks, collect points & win official ST Dance monthly prizes!',
    gameOver: 'GAME OVER',
  ...
  ru: {
    ...
    subtitle: 'Разбивайте блоки, набирайте очки и выигрывайте призы ST Dance!',

...
const quizTranslations = {
  ka: {
    ...
    unlockedTitle: '🎉 4-ე სიცოცხლე გახსნილია! (❤️ #4)',
    ...
    perfectSub: 'შენ უპასუხე 3-ვე შეკითხვას სწორად და დაიმსახურე +1 ბონუს სიცოცხლე (❤️ #4)!',
    claimBtn: 'მიიღე +1 ❤️ & ეთამაშე',
  ...
  en: {
    ...
    unlockedTitle: '🎉 4th Life Unlocked! (❤️ #4)',
    ...
    perfectSub: 'You answered all 3 questions correctly and earned +1 Bonus Life (❤️ #4)!',
    claimBtn: 'Claim +1 ❤️ & Play',
  ...
  ru: {
    ...
    unlockedTitle: '🎉 4-я Жизнь Разблокирована! (❤️ #4)',
    ...
    perfectSub: 'Вы правильно ответили на 3 вопроса и получили +1 Бонусную Жизнь (❤️ #4)!',
    claimBtn: 'Забрать +1 ❤️ и Играть',
